...
<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    ...
    <div class="row align-items-center g-lg-5 py-5">
        <div class="col-lg-7 text-center text-lg-start">
            ...
            <p class="col-lg-10 fs-4">by <a target="_blank" href="https://rizkysaria.netlify.app/">Rizky saria</a></p>
        </div>
    ...
    <div class="row align-items-right g-lg-5 py-5">
        <div class="mx-auto">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    <form id="deleteForm" action="/todolist/{{ $item['id'] }}/delete" method="post" style="display: none">  
                        @csrf
